<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="{{url('/')}}">
            <strong>Privoz</strong>
            <svg version="1.1" id="Capa_1" fill="#38c172" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 width="40px" height="40px" viewBox="0 0 471.175 471.175" style="enable-background:new 0 0 471.175 471.175;"
                 xml:space="preserve">
            <g>
            <g>
